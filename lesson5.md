## List comprehension. Встроенные функции Python. Работа с файлами.
...
4. Создайте программу, которая считывает весь текст из файла и выводит количество символов, слов и строк в нем.

5. Напишите программу, которая копирует содержимое одного файла в другой.

6. Создайте файл, в котором на каждой строке записано число. Напишите программу, которая считает сумму всех чисел в файле.

7. Напишите программу, которая считывает текст из файла и удаляет из него пустые строки.

8. Реализуйте программу, которая находит самую длинную строку в файле и выводит её длину.
