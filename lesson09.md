...
Знакомая ситуация? Когда изменений становится слишком много, легко потерять нужную версию или случайно удалить важную информацию. А теперь представьте, что вы работаете над проектом не один. Каждый делает свои изменения и с каждой версией становится все сложнее следить за проектом.
...
> Например,
> при коммите HEAD и указатель ветки будет двигаться вперёд.
