...
А теперь перейдем к обработке конкретных исключений. И начнем с ошибки `TypeError`, которую мы уже с вами видели на прошлых занятиях. Теперь мы научимся ее отлавливать:)
