...
- **Полу автоматизированное тестирование** – часть шагов выполняется автоматически, но есть действия, требующие участия тестировщика.
...
Это добавлено для того, чтобы мы смогли напрямую запустить этот файл как файл с тестами. В реальности так не делается — дальше покажу, как именно.
