...
1. Проверка входа в систему:
   ...
   Напишите программу, которая запрашивает у пользователя логин и пароль. Если логин "admin" и пароль "12345", вывести "Доступ разрешён". Если логин правильный, но пароль неверный, вывести "Неверный пароль". Если логин неверный, вывести "Пользователь не найден".
...
6. Запросите у пользователя пароль. Если пароль `PythonRocks`, выведите *Доступ разрешён*,
...
Установите правильный пароль `Secret123`. Дайте пользователю три попытки ввести правильный пароль. Если он угадывает – вывести "Доступ разрешён". Если использовал все попытки – "Доступ запрещён!".
