...
10. Создать программу, которая проверяет, является ли введённое число простым (делится только на 1 и себя).
11. Используя вложенные циклы, нарисовать прямоугольник из *.
12. Сгенерировать список квадратов чисел от 1 до 10 с помощью for.
13. Найти факториал числа (5! = 5 × 4 × 3 × 2 × 1).
14. Написать программу, которая запрашивает у пользователя число и печатает таблицу умножения на него.
15. Написать таблицу умножения.
