...
print([] and 42)    # [] (пустой список — ложное значение)
```
...
print([] or 42)      # 42 (пустой список — ложное значение)
...
5. Запросите число у пользователя и определите, четное оно или нечетное.
Выведите "Четное" или "Нечетное".

6. Запросите у пользователя пароль. Если пароль `PythonRocks`, выведите *Доступ разрешен*,
иначе *Неверный пароль*.

7. Запросите у пользователя имя и пароль.Если имя `Admin` и пароль `12345`, выведите *Доступ разрешен*. Если имя `Guest` и пароль `guest`, выведите *Доступ с ограниченными правами*.
Иначе *Ошибка доступа*.

8. Запросите у пользователя день недели (1-7). Если это 1-5, выведите "Будний день". Если 6-7, выведите "Выходной!"